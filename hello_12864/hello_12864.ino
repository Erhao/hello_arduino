...
// Display Settings
const int I2C_DISPLAY_ADDRESS = 0x3c; //iic，0.96，128x64液晶屏的地址。
#if defined(ESP8266)
const int SDA_PIN = D2; //iic液晶屏的SDA接wemosD1mini的D2
const int SDC_PIN = D5;//iic液晶屏的SDA接wemosD1mini的D5
#endif
